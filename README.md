...
1. Project Overview
The e-commerce store Technet requires product performance reports to support decision-making. The goal is to use MongoDB’s Aggregation Framework to efficiently calculate key metrics such as revenue, product popularity, and customer purchasing behavior.
...
•	Order Metrics (total orders, average quantity) provide operational insights.
•	Frequent Products help detect evergreen items to promote further.
